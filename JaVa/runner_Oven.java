...
public class runner_Oven
{
	public static void main(String[] args) {
		...
		while(!instruction.equals("q")){
		    ...
		    System.out.println("Tp preheat the oven enter \"p\", to turn the oven off enter"+" \"o\", to restart enter \"r\", to quit enter \"q\"");
		    ...
		    if(instruction.equals("p")){
		        ...
		        // code to restart the oven//
		        
		    }
		    else{
		        System.out.println("Entered input is wrong, please enter once again..");
		    }
